...
- (void)viewDidLoad {
    ...
    vendorListArray = [[VendorManager sharedInstance] getVendorOfCategory:[NavigationHolder sharedInstance].selectedSubCategory languageID:selectedLanguage];
    
    [btnSubCategoryTitle setTitle:[NavigationHolder sharedInstance].selectedSubCategory.category_name forState:UIControlStateNormal];
    
    objSearchBar.placeholder = [NSString stringWithFormat:@"Search %@", [NavigationHolder sharedInstance].selectedSubCategory.category_name];
