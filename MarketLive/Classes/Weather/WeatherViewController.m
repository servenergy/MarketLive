...
- (void)viewDidLoad {
   ...
   // weatherImageArray= [[NSMutableArray alloc]init];
    ...
    NSString *urlString = [NSString stringWithFormat:@"https://api.darksky.net/forecast/cdc480a3c71ac91c46b31a161c2ff959/8.524139,76.936638"];
    ...
    if(data)
    {
        ...
        NSLog(@"TEMPERATURE in kerala Celsius: %.2f",celsius);
        NSLog(@"TEMPERATURE in kerala Fahreneit: %.2f",fahrenheit);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   /* cell.weatherImage.image = [UIImage imageNamed:[weatherImageArray objectAtIndex:indexPath.row]];
    cell.backgImage.image = [UIImage imageNamed:[backgroundImageArray objectAtIndex:indexPath.row]];*/
